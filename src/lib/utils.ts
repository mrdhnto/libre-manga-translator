// Lightweight browser helpers (fetch, MIME sniffing, streaming downloads,
// tab navigation). Deliberately ORT-free: importing onnxruntime-web here
// would bundle it into the background and content-script single-file builds
// (Firefox AMO 2MB-per-.js limit). ORT-bound downloads live in `models.ts`.
