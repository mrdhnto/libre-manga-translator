...
export const DefaultConfig = {
  ...
  detectionModels: [
    ...
    },
    {
      ...
      label: "YOLO26-Small",
      size: "9.5 MB",
      desc: "Higher accuracy for dense bubble text",
    },
    {
      id: "comic-bubble",
      label: "Comic Bubble Detector (RT-DETR)",
      size: "11.1 MB",
      desc: "Text Bubble & free text detection",
    },
    {
      id: "comic-text-detector",
      label: "Comic Text Detector & Segmentation (JP Flagship)",
      size: "94.7 MB",
      desc: "Text boxes + free text + pixel segmentation mask",
    },
  ],
  llmModels: [
    {
    ...
    },
    {
      ...
      label: "Tiny Aya Global (Language Focus)",
